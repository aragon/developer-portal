...
![Schematic depiction of the versioning taking place in the PluginRepoRegistry.](/optimized-svg/plugins/plugin-repo-overview.drawio.svg#gh-light-mode-only)
![Schematic depiction of the versioning taking place in the PluginRepoRegistry.](/optimized-svg/plugins/plugin-repo-overview-dark.drawio.svg#gh-dark-mode-only)
