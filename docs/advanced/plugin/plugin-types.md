---
title: Plugin Types
sidebar_label: Plugin Types
sidebar_position: 3
---

## The Base Contract for Your Plugin
...
- Depending on your upgradeability requirements and the deployment method you choose, you can also greatly reduce the gas costs to distribute your plugin. However, the upgradeability and deployment method can introduce caveats during [the plugin setup](/docs/advanced/plugin/plugin-setup.md), especially when updating from an older version to a new one.
