...
### Prepare the Update of a plugin

The `prepareUpdate` method performs the prior steps so that a DAO proposal can eventually apply the the update of a Plugin.
