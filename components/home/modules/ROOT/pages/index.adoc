...
The link:https://github.com/aragon/gov-ui-kit[Governance UI Kit] and link:https://github.com/aragon/gov-app-template[Governance App Template] are used to build custom applications and UIs that integrate seamlessly with OSx.
